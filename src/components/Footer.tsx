const Footer = () => {
  return (
    <footer className="bg-dark-brown text-light-cream py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-cream/80 leading-relaxed mb-4">
              Arredamenti di qualità dal 1970. Tradizione artigianale 
              e design contemporaneo per i tuoi spazi.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-cream/80">
              ...
              <li><a href="#valori" className="hover:text-white transition-colors">I Nostri Valori</a></li>
              <li><a href="#galleria" className="hover:text-white transition-colors">Galleria</a></li>
