...
const HeroSection = () => {
  return (
    <section id="home" className="min-h-screen flex items-center bg-gradient-to-br from-light-cream to-warm-beige">
      <div className="container mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="fade-in-up">
            ...
            <button className="px-8 py-4 bg-dark-brown text-light-cream rounded-lg hover:bg-primary/90 transition-colors font-medium">
